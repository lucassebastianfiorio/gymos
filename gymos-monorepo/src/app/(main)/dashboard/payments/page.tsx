...
import { AdminPaymentsView } from './_components/admin-payments-view'; // Import the new component

export default function PaymentsPage() {
    const { user } = useAuthStore();
    
    // Determine if we should show admin view
    const isAdminOrStaff = user?.role === UserRole.AdminGlobal || 
            ...
            <div className="flex flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Administra los cobros, caja y estado financiero.</p>
                    </div>
                </div>
                <AdminPaymentsView />
            </div>
